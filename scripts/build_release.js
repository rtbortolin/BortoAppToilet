...
publisher.transport.remoteUrl = publisher.transport.remoteUrl.replace('{host}', CONSTs.host)
  .replace('{port}', CONSTs.serverPort);
publisher.updatesJsonUrl = publisher.updatesJsonUrl.replace('{host}', CONSTs.host)
  .replace('{port}', CONSTs.serverPort);
